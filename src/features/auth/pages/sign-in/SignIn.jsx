    ...
    <>
      ...
      >
        <Form className="bg-white rounded-md shadow-2xl p-5">
          ...
          <p className="text-sm font-normal text-gray-600 mb-8 uppercase">Đăng nhập</p>
          ...
          <div className="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl ">
            ...
            <TextInput type="password" name="password" id="password" placeholder="Mật khẩu" />
          ...
          <div className="flex justify-between mt-4">
            <Link to="/auth/identify" className="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Quên mật khẩu ?</Link>

            <Link to="/auth/sign-up" className="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Chưa có tài khoản?</Link>
          </div>
        </Form>
      </Formik>
    </>
